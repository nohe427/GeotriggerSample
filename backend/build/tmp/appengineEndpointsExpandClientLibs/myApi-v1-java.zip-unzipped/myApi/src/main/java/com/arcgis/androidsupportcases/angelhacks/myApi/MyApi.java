 ...
 * on 2016-05-21 at 17:15:05 UTC 
 * Modify at your own risk.
 */

package com.arcgis.androidsupportcases.angelhacks.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.arcgis.androidsupportcases.angelhacks.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.arcgis.androidsupportcases.angelhacks.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "updateFeature".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link UpdateFeature#execute()} method to invoke the remote operation.
   *
   * @param content the {@link java.lang.Object}
   * @return the request
   */
  public UpdateFeature updateFeature(java.lang.Object content) throws java.io.IOException {
    UpdateFeature result = new UpdateFeature(content);
    initialize(result);
    return result;
  }

  public class UpdateFeature extends MyApiRequest<Void> {
     ...
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link UpdateFeature#execute()} method to invoke the remote operation. <p>
     * {@link UpdateFeature#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientR
     ...
     * @since 1.13
     */
    protected UpdateFeature(java.lang.Object content) {
      super(MyApi.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public UpdateFeature setAlt(java.lang.String alt) {
      return (UpdateFeature) super.setAlt(alt);
    }

    @Override
    public UpdateFeature setFields(java.lang.String fields) {
      return (UpdateFeature) super.setFields(fields);
    }

    @Override
    public UpdateFeature setKey(java.lang.String key) {
      return (UpdateFeature) super.setKey(key);
    }

    @Override
    public UpdateFeature setOauthToken(java.lang.String oauthToken) {
      return (UpdateFeature) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateFeature setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateFeature) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateFeature setQuotaUser(java.lang.String quotaUser) {
      return (UpdateFeature) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateFeature setUserIp(java.lang.String userIp) {
      return (UpdateFeature) super.setUserIp(userIp);
    }

    @Override
    public UpdateFeature set(String parameterName, Object value) {
      return (UpdateFeature) super.set(parameterName, value);
    }
  }
